...
if text == '1' or text == 'One' or text == 'one':
    ...
    sendermail='srini.pit21@gmail.com'
    recvmail='vennila26041999@gmail.com'
    msg='what about your adv.java learning progress'
    mail.login(sendermail,'jwjprmtwxcwqcmjd') #login using app password
    mail.sendmail(sendermail,recvmail,msg) #send part
